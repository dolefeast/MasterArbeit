...
for i, eigenstate in enumerate(eigenstate_array):
    ...
    ax_fields.plot(system.z,  eigenstate.sol(system.z)[0]/omega_solution, fmt, alpha=0.5, linewidth=0.6)
    ax_omegas.scatter(np.sqrt(omega_solution**2 - m**2)/np.pi, omega_solution, marker='x')
