def fullScript(self):
    while self.lambdaValue < self.lambdaMax:
        ...
        # To distinguish between different lambda values in plotting
        ...
        assert len(self.eigenvalues) == self.maxN + (self.bcs=="neumann"), print("len(self.eigenvalues) =", len(self.eigenvalues), "!=", self.maxN+(self.bcs=="neumann"))
