...
class Vacuum_Polarization:
    ...
    "#C52E19FF, #AC9765FF, #54D8B1FF, #B67C3BFF, #175149FF, #AF4E24FF".split(", ")
        ...
        self.bisectionTol = bisectionTol # Tolerance for the eigenvalues
    ...
    from Vacuum_Polarization2.filterRoutines import (
            extendSignal, 
            removeNeighbourhood,
    ...
    from Vacuum_Polarization2.smallRoutines import (
            sign,
            floatToStr,
            strToFloat,
            rootMeanSquare,
    ...
    from Vacuum_Polarization2.plottingSetup import (
            plottingSetup,
            plotRhoA0Induced,
    ...
    from Vacuum_Polarization2.bisectionRoutines import (
            findRootBisection,
            bisectionMethodUpperBound,
            bisectionMethodLowerBound,
            )
    from Vacuum_Polarization2.physics import (
            KleinGordonEquation
            )
    from Vacuum_Polarization2.perturbativeSolutions import(
    ...
    from Vacuum_Polarization2.calculateEigenstatesRoutines import (
    ...
    from Vacuum_Polarization2.saveSolutionsRoutine import saveSolutions
    from Vacuum_Polarization.perturbativeApproximations import (perturbativePhi)

    from Vacuum_Polarization2.inducedFieldsRoutines import (
            calculateRho,
    ...
    from Vacuum_Polarization2.mainScript import (
            coreIteration,
